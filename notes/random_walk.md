...
A problem with this is the walk can get trapped (e.g., "Claim Echo Loops" where two sources copy each other's specifications) or hit dead ends (e.g., a claim appears on a single obscure source).
