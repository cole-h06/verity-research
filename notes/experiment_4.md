...
This could be a multitude of things like graph structure, source degree effects, duplicate information reinforcing itself, missing disagreement propagation, or, perhaps, just something wrong in the operator itself...

Explicit disagreement has also not been implemented yet. Currently, agreement only adds support. Conflicting claims don't directly subtract credibility.
