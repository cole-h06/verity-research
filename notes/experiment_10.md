...
First, for each pair of `(product_id, canonical_attribute)`, all assertions are grouped based on their values after deterministic canonicalization is applied. 
